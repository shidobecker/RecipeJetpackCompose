...
import br.com.shido.recipecompose.utils.loadPicture

const val DEFAULT_IMAGE_PLATE = R.drawable.empty_plate
    ...
    Card(
        ...
        Column {
            recipe.featuredImage?.let { url ->
                val image = loadPicture(url = url, defaultImage = DEFAULT_IMAGE_PLATE).value
